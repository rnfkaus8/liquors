...
class LiquorApiControllerTest(
    ...
    fun findAll() {
        ...
        liquorRepository.flush()
        val liquor2 = Liquor(name = "버팔로 트레이스", LiquorRating.VERY_GOOD, category = childCategory)
        liquorRepository.save(liquor2)
        liquorRepository.flush()
        val liquor3 = Liquor(name = "버팔로 트레이스", LiquorRating.VERY_GOOD, category = childCategory)
