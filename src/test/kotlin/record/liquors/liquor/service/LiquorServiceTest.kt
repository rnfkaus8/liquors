...
class LiquorServiceTest(
  ...
  fun save() {
    ...
    val savedLiquorId = liquorService.save(
      LiquorSaveRequest(
        name = liquor.name,
    ...
    val findLiquor = liquorService.findOne(savedLiquorId)
    
    assertThat(savedLiquorId).isEqualTo(findLiquor.id)
  }
  ...
  fun findAll() {
    ...
    assertThat(findLiquors.toList()).isEqualTo(listOf(LiquorResponse.toDto(liquor1), LiquorResponse.toDto(liquor2)))
  }
